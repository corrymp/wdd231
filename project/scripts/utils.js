...
const httpToHttps = (url) => `https:${url.split(':')[1]}`;

async function get(url) { return await (await fetch(url, { headers: { 'User-Agent': 'this-header-should-be-enough-to-identify-me-i-am-corry-palmer-and-this-is-my-final-project-for-a-web-dev-course' } })).json(); }

export { ge, get, parseBool, toggle, dialog, httpToHttps }